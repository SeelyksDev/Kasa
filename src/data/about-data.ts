...
export const aboutData:AboutDataItem[] = [
      ...
      {
            "title": "Service",
            "texte": "La qualité de service est au coeur de notre engagement chez Kasa. Nous veillons à ce que chaque interaction, que ce soit avec nos hôtes ou nos locataires, soit empreinte de respect et de bienveillance."
      },
      {
            "title": "Sécurité",
